<script>
  ...
  async function createTransferTier(
    erc20Token,
    tier1,
    tier2,
    tier3,
        ...
        provider
          ...
          .then(() => {
            ...
            signer.getAddress().then((address) => {
              ...
              rainSDK.ERC20TransferTier.deploy(signer, tierState).then(
                (result) => {
                  resolve(result);
                }
              );
  ...
  console.log("Creating Transfer Tier, please wait.")
...
<div class="d-flex align-items-center justify-content-between">
  <div class="d-flex">
    Create Transfer Tier (see console)
  </div>
</div>
